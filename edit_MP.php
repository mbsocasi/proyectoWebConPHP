    ...
    <div class="row">
        ...
        <form method="POST">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="nombpro" name="nombpro" value="<?php echo $row['nombpro']; ?>">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="descpro" name="descpro" value="<?php echo $row['descpro']; ?>">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="marcapro" name="marcapro" value="<?php echo $row['marcapro']; ?>">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" id="fechapro" name="fechapro" value="<?php echo $row['fechapro']; ?>">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="cantpro" name="cantpro" value="<?php echo $row['cantpro']; ?>">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                 <select class="form-control" name="unipro" id="unipro" >
                    <option value="litros"<?php if ($row['unipro'] == 'litros') { echo ' selected'; } ?>>litros</option>
                    <option value="kg"<?php if ($row['unipro'] == 'kg') { echo ' selected'; } ?>>kg</option>
                    <option value="libras"<?php if ($row['unipro'] == 'libras') { echo ' selected'; } ?>>libras</option>
                    <option value="unidades"<?php if ($row['unipro'] == 'unidades') { echo ' selected'; } ?>>unidades</option>
                     </select>
                </div>
            </div> 
        ...
        <select class="form-control" name="proveedor" id="proveedor">
            <?php
                ...
                foreach($proveedores as $proveedor) {
                    ...
                    if ($row['proveedor'] == $proveedor['nombre']) {
                        echo ' selected';
                    }
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="float" class="form-control" id="preciopro" name="preciopro" value="<?php echo $row['preciopro']; ?>">
